    ...
    <>
      ...
      >
        <div className="flex items-center justify-center w-full">
          <div className="pb-2 pr-1 bg-gradient-to-b from-blue-600 to-blue-800 rounded-2xl border-2 border-stone-800 drop-shadow-md">
            <div className="p-10 shadow-inner shadow-cyan-300 bg-gradient-to-b from-blue-400 to-blue-500 rounded-2xl">
              <div className="p-10 shadow-inner shadow-[#ffdcb5] bg-gradient-to-b from-[#fcba7e] to-[#febe81] rounded-2xl border-b-2 border-r-2 border-[#6e3c19]">
